            ...
            <div className="relative p-8 flex flex-col items-center">
              ...
              {reason === 'limit_agents' && !urgency && (
                <div className="w-full bg-[var(--bg-card)] border border-[var(--border-default)] rounded-lg p-3 mb-6 flex items-center justify-center">
                  <span className="text-[13px] text-[var(--text-primary)]">
                    The free plan includes 3 agents. Upgrade to Growth to monitor up to 10 agents.
                  </span>
                </div>
              )}
              ...
              <div className="w-full border border-[var(--border-subtle)] rounded-lg overflow-hidden mb-6 text-[14px]">
                 <div className="flex bg-[var(--bg-main)]">
                    <div className="flex-1 p-3 font-semibold text-[var(--text-secondary)] border-r border-[var(--border-subtle)]">FREE</div>
                    <div className="flex-1 p-3 font-bold text-[var(--accent-amber)] bg-[var(--accent-amber-dim)]">GROWTH</div>
                 </div>
                 <div className="flex border-t border-[var(--border-subtle)]">
                    <div className="flex-1 p-3 text-[var(--text-secondary)] border-r border-[var(--border-subtle)]">3 agents</div>
                    <div className="flex-1 p-3 text-white">10 agents</div>
                 </div>
                 <div className="flex border-t border-[var(--border-subtle)]">
                    <div className="flex-1 p-3 text-[var(--text-secondary)] border-r border-[var(--border-subtle)]">10K traces/month</div>
                    <div className="flex-1 p-3 text-white">500K traces/month</div>
                 </div>
                 <div className="flex border-t border-[var(--border-subtle)]">
                    <div className="flex-1 p-3 text-[var(--text-secondary)] border-r border-[var(--border-subtle)]">7-day history</div>
                    <div className="flex-1 p-3 text-white">30-day history</div>
                 </div>
              </div>
              ...
              <div className="w-full space-y-3">
                ...
                <div className="text-center">
                   <div className="text-[11px] text-[var(--text-tertiary)] mb-4">or $15/month billed annually</div>
                   <button className="text-[11px] text-[var(--text-tertiary)] hover:text-white transition-colors" onClick={closePremiumModal}>
                     Maybe later
                   </button>
                </div>
              </div>
