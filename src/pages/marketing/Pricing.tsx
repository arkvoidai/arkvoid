...
{ text: '250K traces / month', included: true },
...
{ text: '1M traces / month', included: true },
...
a: 'Yes. We support customers globally with secure Stripe payments.'
},
{
...
<meta
name="description"
content="Infrastructure for trusted AI systems."
/>
</Helmet>
    ...
    >
      {pricingPlans.map((plan) => (
        ...
        >
          ...
          <p className="text-[14px] text-[#A1A1A6] mb-6 min-h-[48px]">
            {plan.tagline}
          </p>

          <div className="mb-8">
            {plan.price === 'Custom' ? (
              <div className="text-[48px] font-bold text-white tracking-[-0.04em]">
                Custom
              </div>
            ) : (
          ...
          <div className="text-[11px] text-[#6E6E73] text-center mb-8 h-[16px]">
            {plan.note}
          </div>
