...
export function AdminLogin() {
  ...
  useEffect(() => {
    ...
    console.warn('%c⚠️ STOP!', 'color: red; font-size: 30px; font-weight: bold');
  ...
  return (
    <div
      className="min-h-screen bg-[#080808] flex items-center justify-center p-4 relative"
      ...
      <div className="relative z-20 w-full max-w-[400px] mt-[10vh] mx-auto">
        <div className="bg-[#0F0F0F] rounded-xl border border-[#1E1E1E] p-9 shadow-2xl relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Honeypot */}
            <input type="text" name="username" ref={honeypotRef} className="hidden" aria-hidden="true" tabIndex={-1} autoComplete="off" />
